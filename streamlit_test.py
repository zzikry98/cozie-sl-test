...
st.set_page_config(layout="wide", page_icon=":watch:")
st.title("Cozie dashboard")
...
with st.spinner("Loading data..."):
  ...
  plotly_labels = {"vote_count": "Counts", "id_participant": "Participant ID", "date_time": "Date & Time"}
